...
const DEFAULT_TIME_LABEL_STYLE = {color: colors.COLOR_WHITE};
...
class CountDownComponent extends React.Component {
  ...
  componentWillUnmount() {
    ...
    AppState.removeListeners('change', this._handleAppStateChange);
  }
  ...
  renderLabel = label => {
    ...
    if (label) {
      return (
        <Text style={[styles.timeTxt, {fontSize: size}, timeLabelStyle]}>
          {label}
        </Text>
      );
    }
